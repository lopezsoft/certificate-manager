...
export const coreConfig: CoreConfig = {
  app: {
    appName     : environment.config.name,                                   // App Name
    appTitle    : environment.config.title, // App Title
    appLogoImage: environment.config.logo,         // App Logo
    appLogoHome:  environment.config.logoHome,         // App Logo
  },
  layout: {
    skin  : environment.config.skin as any,   // default, dark, bordered, semi-dark
