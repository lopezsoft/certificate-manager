 ...
 *     @OA\Property(property="kyc_flow_completed_at", type="string", format="date-time", nullable=true, example="2026-08-21T15:40:00Z", description="Cuándo el navegador del suscriptor llegó al callback tras completar MetaMap. Es solo una señal de que el cliente terminó el flujo — NO confirma que Viafirma aprobó la identidad; eso lo determina remote_status/internal_state."),
