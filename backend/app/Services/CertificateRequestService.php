    ...
    public function createCertificateRequest(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $certificate    = CertificateRequest::create([
                ...
                'document_number' => strip_tags($request->document_number),
                'address' => strip_tags($request->address),
                'legal_representative' => Str::upper(strip_tags($request->legal_representative)),
                'company_name' => Str::upper(strip_tags($request->company_name)),
                'dni' => strip_tags($dni),
                'dv' => $dv,
