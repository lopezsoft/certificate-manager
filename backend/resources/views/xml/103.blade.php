...
<NominaIndividualDeAjuste
    ...
    <TipoNota>{{ $adjustmentNoteType->code }}</TipoNota>
    @if($adjustmentNoteType->code == 1)
    <Reemplazar>
        {{-- Replaccing predecessor --}}
        @include('xml._ep_replacing_predecessor')
        {{-- Period --}}
    ...
    <Eliminar>
        ...
        @include('xml._ep_deleting_predecessor')
        {{-- Número de secuencia del XML  --}}
        @include('xml._ep_sequence_number')
        {{-- Lugar de generación del XML  --}}
        @include('xml._ep_generation_place')
        ...
        @include('xml._ep_provider')
        {{-- Informacion general  --}}
        @include('xml._ep_general_information_deleting')
        {{-- Informacion empleador  --}}
        @include('xml._ep_employer')
    </Eliminar>
    @endif
